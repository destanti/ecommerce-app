            ...
            <div class="col-lg-12 col-xl-7">
                <div class="card">
                    <div class="card-body p-5">
                        ...
                        <p class="fs-sm">
                            This is the receipt for a payment of <strong>@rupiah($checkout->total)</strong> you made to My Healthy Shop.
                        </p>
                        ...
                        <div class="border-top border-gray-200 mt-4 py-4">
                            <div class="row">
                                <div class="col-md-6 text-md-start">
                                    ...
                                    <p class="text-danger text-uppercase-bold">{{$checkout->status}}</p>
                                </div>
                            </div>
                        </div>
